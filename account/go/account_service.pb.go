...
var file_account_service_proto_goTypes = []any{
	...
	(*_go.Pagination)(nil),    // 8: pagination.Pagination
...
var file_account_service_proto_depIdxs = []int32{
	...
	8,  // 1: account.GetUsersRequest.pagination:type_name -> pagination.Pagination
	9,  // 2: account.GetUserResponse.user:type_name -> account.User
	9,  // 3: account.GetUsersResponse.users:type_name -> account.User
	8,  // 4: account.GetUsersResponse.pagination:type_name -> pagination.Pagination
